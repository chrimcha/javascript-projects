...
// or use below code to just return and print at the same time without reassigning dna
...
console.log(`The DNA string is ${dnaTwo.replaceAll("-","").length} characters long with out the hyphens.`)

//5) Just for fun, apply methods to ``dna`` and use another template literal to print, 'taco cat'.
console.log(`${dna.slice(4,7).toLowerCase()}o ${dna.slice(dna.indexOf('CAT'),dna.indexOf('CAT')+3).toLowerCase()}`); //only returns taco if i don't use the +3 in the second slice
